...
def main(args, extras) -> None:
    ...
    from threestudio.utils.config import ExperimentConfig, load_config, post_init
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seed", required=False, default=-1,type=int, help="seed for random number generators")
